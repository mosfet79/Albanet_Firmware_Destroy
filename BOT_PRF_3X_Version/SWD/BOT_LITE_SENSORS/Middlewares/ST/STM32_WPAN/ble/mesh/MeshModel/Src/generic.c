                                                 ...
                                                 MOBLEBOOL response)
{
  ...
  uint8_t Albanet_Parameter = pRxData[0];
/*Selecting PIR Sensor State*/
  if (Albanet_Parameter == 0x02){
	  /*External Option to Integrate PIR ENABLE*/
      function_sensor(0x01,0x13);
  }else if(Albanet_Parameter == 0x03){
	  /*External Option to integrate PIR DISABLE*/
	  function_sensor(0x00,0x13);
  }else if(Albanet_Parameter == 0x04){
	  /*External Option to Integrate LIGHT ENABLE*/
      function_sensor(0x01,0x14);
  }else if(Albanet_Parameter == 0x05){
	  /*External Option to Integrate LIGHT DISABLE*/
      function_sensor(0x00,0x14);
  }else if(Albanet_Parameter == 0x06){
	  albanet_WEB_dimmer(10);
  }else if(Albanet_Parameter == 0x07){
      albanet_WEB_dimmer(20);
  }else if(Albanet_Parameter == 0x08){
      albanet_WEB_dimmer(30);
  }else if(Albanet_Parameter == 0x09){
      albanet_WEB_dimmer(40);
  }else if(Albanet_Parameter == 0x0A){
      albanet_WEB_dimmer(50);
  }else if(Albanet_Parameter == 0x0B){
      albanet_WEB_dimmer(60);
  }else if(Albanet_Parameter == 0x0C){
      albanet_WEB_dimmer(70);
  }else if(Albanet_Parameter == 0x0D){
      albanet_WEB_dimmer(80);
  }else if(Albanet_Parameter == 0x0E){
      albanet_WEB_dimmer(90);}
