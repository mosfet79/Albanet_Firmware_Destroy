                               ...
                               MODEL_MessageHeader_t *pmsgParam)
{
  ...
  */
  ...
  /*Here will be embedded the conditions to filter options through Lighting Dimming Value*/

  BSP_LED_Toggle(LED_RED);
  uint16_t valuetoselect = Light_LightnessStatus[pmsgParam->elementIndex].LinearPresentValue16;
  uint8_t demo_selector = valuetoselect >> 8;

  /*Checking inserting values on different scenarios for BUS.*/
  //VEML6040_readSensor(demo_selector);

#if(DEMO_VERSION == 1)

  /*--------------- Lighting 15% ------------------------ */
  if (demo_selector == 0x06){
	  /*Function to enable PIR and Disable Light Sensor*/
	  option01 = 1;
	  option02 = 0;
	  option03 = 0;
	  option04 = 0;
	  ...
	  option06 = 0;
  /*----------------Lighting 20% -------------------------*/
  }else if(demo_selector == 0x0A){
	  /*Function to enable Light Sensor (300 LUX) and Disable PIR*/
	  option02 = 1;
	  option01 = 0;
	  option03 = 0;
	  option04 = 0;
	  ...
	  option06 = 0;
  /*----------------Lighting 25% -------------------------*/
  }else if( demo_selector == 0x0F){
	  /*Function enable PIR 15 Seconds OFF*/
	  option03 = 1;
	  option01 = 0;
	  option02 = 0;
	  option04 = 0;
	  ...
	  option06 = 0;
  /*----------------Lighting 30 % ------------------------*/
  }else if (demo_selector == 0x17){
	  /*Function enable PIR 30 Seconds OFF*/
	  option04 = 1;
	  option01 = 0;
	  option02 = 0;
	  option03 = 0;
	  ...
	  option06 = 0;
  /*----------------Lighting 35 % ------------------------*/
  }else if(demo_selector == 0x21){
	  /*Function enable PIR 60 Seconds OFF*/
	  option05 = 1;
	  option01 = 0;
	  option02 = 0;
	  option03 = 0;
	  ...
	  option06 = 0;
  /*----------------Lighting 40% -------------------------*/
  }else if(demo_selector == 0x2B){
	  /*Function Enable Light Sensor in (100 LUX)*/
	  option06 = 1;
	  option01 = 0;
	  option02 = 0;
	  option03 = 0;
