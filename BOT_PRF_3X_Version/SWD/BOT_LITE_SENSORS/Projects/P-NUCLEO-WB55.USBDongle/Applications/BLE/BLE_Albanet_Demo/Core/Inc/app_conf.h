 ...
 * Define Tx Power
 */   
#define CFG_TX_POWER                      (0x31) /**< +0 dBm */
...
#define PUSH_BUTTON_SW2_EXTI_IRQHandler                         EXTI2_IRQHandler
...
typedef enum
{
  ...
  /*Function to Integrate a new routine on sequencer*/
  CFG_I2C_BUS_TESTER_REQ_ID,
  /* Function to integrate PIR Sensor on sequencer*/
  CFG_PIR_SENSOR_REQ_ID,
  /* Function to integrate LIGHT Sensor on sequence*/
  CFG_LIGHT_SENSOR_REQ_ID,
...
typedef enum
{
  ...
  /*Exclusive Albanet Task to be included on Senquencer*/
  CFG_LED_TESTER_ID,
