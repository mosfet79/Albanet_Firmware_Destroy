...
/* Actions to check ALBANET System considering Manufacturing Process */
#define ALBANET_BOT_LED_TEST			1
...
static void Appli_UpdateButtonState(int isPressed)
{
  ...
  TRACE_M(TF_PROVISION,"Pressing SW1 ... \r\n");
...
/* Hardware Factory Restore implementation */
  ...
  /*This is to avoid and initial value while Power Up the System*/
