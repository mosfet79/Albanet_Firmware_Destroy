...
/*Buffer to integrate data TX RX*/
uint8_t aTxBuffer_i2c[] = "***Message to Integrate***";

/*Variable to integrate the new way to communicate on system*/
uint8_t aRxBuffer_i2c[RXBUFFERSIZE];
...
/*Buffer used to integrate data from sensors*/
...
//  HAL_RCC_MCOConfig(RCC_MCO1, RCC_MCO1SOURCE_SYSCLK, RCC_MCODIV_16);
  ...
  /*Turn ON RED LED if I2C isnt't ready*/
...
/* ------ FUNCTIONS TO INTEGRATE I2C BUS CONSIDERING SETUP AND STARTUP ------*/

static void MX_I2C1_Init(void)
{
	hi2c1.Instance = I2C1;
	hi2c1.Init.Timing = 0x00000E14;
	hi2c1.Init.OwnAddress1 = STM32WB55;
...
/* ----- FUNCTION TO INTEGRATE THE GPIOS -----*/
static void MX_GPIO_Init(void)
{
...
/* ----- I2C MSP INITIALIZATION, CONFIGURING HARDWARE RESOURCES -----*/
/* -----              Using I2C Handle Pointer                  -----*/
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
	...
	if(hi2c -> Instance==I2C1)
	{
		...
		/*Configure I2C Clock Source, the clock derived from SYSCLK*/
	    RCC_PeriphCLKInitStruct.PeriphClockSelection = RCC_PERIPHCLK_I2C1;
	    RCC_PeriphCLKInitStruct.I2c1ClockSelection = RCC_I2C1CLKSOURCE_SYSCLK;
	    HAL_RCCEx_PeriphCLKConfig(&RCC_PeriphCLKInitStruct);

	    /*Enable Port B to integrate I2C Pins*/
	    ...
	    HAL_NVIC_EnableIRQ(I2C1_ER_IRQn);  /* USER CODE BEGIN I2C1_MspInit 1 */
