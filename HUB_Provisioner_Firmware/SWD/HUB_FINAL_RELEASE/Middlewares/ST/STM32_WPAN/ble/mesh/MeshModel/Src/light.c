                                               ...
                                               MOBLEUINT16 *length)
{
  ...
  *length = sizeof(Light_Opcodes_Table)/sizeof(Light_Opcodes_Table[0]);
   TRACE_M(TF_MISC,"SERVER EXECUTION %d  %d!!!\r\n", *data, *length);
                                    ...
                                    MOBLEBOOL response)
{
  ...
  TRACE_M(TF_MISC,"SECOND PROCESS!!!\r\n");
  ...
  TRACE_M(TF_MISC,"ENABLE LIGHT MODEL SERVER SECOND PROCESS!!!\r\n");
                                                 ...
                                                 )
{
  ...
  TRACE_M(TF_MISC,"dst_peer = %.2X , peer_add = %.2X, opcode= %.2X,response= %.2X \r\n ",dst_peer, peer_addr, opcode,response);
  ...
  case LIGHT_LIGHTNESS_SET_UNACK:
    {       
  	  TRACE_M(TF_MISC,"PROCESSING MESSAGE!!!\r\n");
